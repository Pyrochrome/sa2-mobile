...
static const u16 zoneLoadingCharacterLogos[NUM_CHARACTERS][3] = {
    ...
    [CHARACTER_AMY] = { 9, SA2_ANIM_STAGE_INTRO_CHARACTER_LOGO, 4 }, [CHARACTER_NEW] = { 9, SA2_ANIM_STAGE_INTRO_CHARACTER_LOGO, 0 },
};
...
static const TileInfo characterAnimsGettingReady[NUM_CHARACTERS] = {
    ...
    [CHARACTER_NEW] = { 0, SA2_ANIM_CHAR(SA2_CHAR_ANIM_BEFORE_COUNTDOWN, CHARACTER_NEW), 0 },
};
...
const TileInfo sColoredTriangle[NUM_CHARACTERS] = {
    ...
    [CHARACTER_AMY] = { 0x54, SA2_ANIM_STAGE_INTRO_TRIANGLES, 3 }, [CHARACTER_NEW] = { 0x54, SA2_ANIM_STAGE_INTRO_TRIANGLES, 3 },
};

static const u8 sGettingReadyAnimationDuration[NUM_CHARACTERS]
    = { [CHARACTER_SONIC] = 40, [CHARACTER_CREAM] = 55, [CHARACTER_TAILS] = 52, [CHARACTER_KNUCKLES] = 40, [CHARACTER_AMY] = 40, [CHARACTER_NEW] = 40 };
...
const u16 sZoneLoadingCharacterColors[NUM_CHARACTERS] = {
    ...
    [CHARACTER_KNUCKLES] = RGB16(31, 3, 0), [CHARACTER_AMY] = RGB16(31, 17, 21), [CHARACTER_NEW] = RGB16(0, 0, 31),
};
